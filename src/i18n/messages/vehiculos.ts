export const vehiculosMessages = {
  es: {
    ...
    editSubtitle: 'Modifica los datos del vehículo',
    newSubtitle: 'Registra un nuevo vehículo en el sistema',
    ...
    noResultsWithStatus: 'No se encontraron vehículos en estado {status}.',
    ...
    labelSerial: 'Serial / VIN',
    placeholderSerial: 'Ej. 1HGBH41JXMN109186',
  ...
  en: {
    ...
    editSubtitle: 'Modify vehicle details',
    newSubtitle: 'Register a new vehicle in the system',
    btnNew: 'New Vehicle',
    ...
    noResultsWithStatus: 'No vehicles found with status {status}.',
    ...
    labelSerial: 'Serial / VIN',
    placeholderSerial: 'e.g., 1HGBH41JXMN109186',
