/**
 * useGoogleMaps.ts (shared)
 * ─────────────────────────────────────────────────────────────
 * Composable singleton para la carga de la API de Google Maps.
 *
 * PROBLEMA que resuelve:
 *   Múltiples componentes inyectaban su propio <script> en el
 *   <head>, provocando que Google Maps se cargara varias veces
 *   al navegar entre vistas, causando lentitud.
 *
 * SOLUCIÓN:
